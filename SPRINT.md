...
- [ ] Phase 2 — Platform clients + live wiring: YouTube/IG API clients, Post Queue DB, GH Actions tick, Zo watchdog, dry-run E2E
...
## Next
Execute plan Task 9A (YouTube client) → 9B (IG client) → 9C (rewire tick, drop Postiz).
